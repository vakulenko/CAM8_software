// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam8 v.0.5
// Edit Log:
...
namespace ASCOM.cam8_v05
{
    ...
    public class Camera : ICameraV2
    {
        ...
        public static string driverID = "ASCOM.cam8_v05.Camera";
        private static string driverDescription = "Cam8 v.0.5 ASCOM Driver";
...
#endif
        /// <summary>
        /// Initializes a new instance of the <see cref="cam81_v05"/> class.
        /// Must be public for COM registration.
        /// </summary>
        /// 

        //Imports cam8ll05.dll functions
        [DllImport("cam8ll05.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        public bool ImageReady
        {
            get
            {
                //get imare_ready flag from cam8ll05.dll
