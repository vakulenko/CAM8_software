...
namespace ASCOM.cam8s_v055
{
    [Guid("8a4adc64-10e4-43d4-ad06-f112b1607675")]
    ...
    public class Camera : ICameraV2
    {
        ...
        public static string driverID = "ASCOM.cam8s_v055.Camera";
        private static string driverDescription = "Cam8s v.0.55 ASCOM Driver";
        ...
        //Imports cam8sll055.dll functions
        [DllImport("cam8sll055.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        public bool ImageReady
        {
            get
            {
                //get imare_ready flag from cam8sll055.dll
