// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam8 v.0.7
// Edit Log:
...
namespace ASCOM.cam8_v07
{
    /// <summary>
    /// ASCOM Camera Driver for cam8_v07.
    /// </summary>
    [Guid("86fc18c7-503e-4633-89e7-6ee3925e59eb")]
    ...
    public class Camera : ICameraV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.cam8_v07.Camera";

        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "Cam8 v.0.7 ASCOM Driver";
        ...
        //Imports cam8ll07.dll functions
        ...
        public bool Connected
        {
            ...
            set
            {
                ...
                if (value)
                {
                    tl.LogMessage("Connected Set", "Connecting to camera, call cameraConnect from cam8ll07.dll");
                ...
                {
                    tl.LogMessage("Connected Set", "Disconnecting from camera, call cameraConnect from cam8ll07.dll");
        ...
        {
            tl.LogMessage("AbortExposure", "Aborting exposure, call cameraStopExposure from cam8ll07.dll");
        ...
        public object ImageArray
        {
            get
            {
                ...
                uint imagepoint;
                //Get image pointer
                tl.LogMessage("ImageArray Get", "Call cameraGetImage from cam8ll07.dll");
        ...
        public bool ImageReady
        {
            get
            {
                tl.LogMessage("ImageReady Get", "Call cameraGetImageReady from cam8ll07.dll");
        ...
        private bool IsConnected
        {
            get
            {
                tl.LogMessage("IsConnected Get", "Call cameraIsConnected from cam8ll07.dll");
