...
// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam85 v.0.1
// Edit Log:
// Date			Who	Vers	Description
// -----------	---	-----	-------------------------------------------------------
// 24-sep-2015  VSS 0.1     Initial release for cam85 based on cam8s v.0.1 ASCOM driver
// --------------------------------------------------------------------------------
...
namespace ASCOM.cam85_v01
{
    /// <summary>
    /// ASCOM Camera Driver for cam85_v01.
    /// </summary>
    [Guid("e89a2082-fe3a-4794-b07d-507d5eeb9cb8")]
    ...
    public class TECControl
    {
        ...
        public TECControl(string comPort, bool traceEnabled)
        {
            ...
            tectl = new TraceLogger("", "tec_cam85_v01");
    ...
    public class Camera : ICameraV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.cam85_v01.Camera";

        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "Cam85 v.0.1 ASCOM Driver";
        ...
        //Imports cam85ll01.dll functions
        [DllImport("cam85ll01.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="cam85_v01"/> class.
        ...
        public bool Connected
        {
            ...
            set
            {
                ...
                if (value)
                {
                    tl.LogMessage("Connected Set", "Connecting to camera, call cameraConnect from cam85ll01.dll");
                ...
                {
                    tl.LogMessage("Connected Set", "Disconnecting from camera, call cameraConnect from cam85ll01.dll");
        ...
        {
            tl.LogMessage("AbortExposure", "Aborting exposure, call cameraStopExposure from cam85ll01.dll");
        ...
        public CameraStates CameraState
        {
            get
            {
                tl.LogMessage("CameraState Get", "Call cameraGetError from cam85ll01.dll");
                ...
                tl.LogMessage("CameraState Get", "Call cameraGetCameraState from cam85ll01.dll");
        ...
        public object ImageArray
        {
            get
            {
                ...
                uint imagepoint;
                //Get image pointer
                tl.LogMessage("ImageArray Get", "Call cameraGetImage from cam85ll01.dll");
        ...
        public bool ImageReady
        {
            get
            {
                tl.LogMessage("ImageReady Get", "Call cameraGetImageReady from cam85ll01.dll");
        ...
        public void StartExposure(double Duration, bool Light)
        {
            ...
            tl.LogMessage("StartExposure", "Call cameraSetGain from cam85ll01.dll args: gain=" + settingsForm.gain.ToString());
            ...
            tl.LogMessage("StartExposure", "Call cameraSetOffset from cam85ll01.dll args: offset=" + settingsForm.offset.ToString());
            ...
            //start exposure
            tl.LogMessage("StartExposure", "Call cameraStartExposure from cam85ll01.dll, args: ");
        ...
        private bool IsConnected
        {
            get
            {
                tl.LogMessage("IsConnected Get", "Call cameraIsConnected from cam85ll01.dll");
