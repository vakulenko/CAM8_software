// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam8 v.0.51
// Edit Log:
...
namespace ASCOM.cam8_v051
{
    ...
    public class Camera : ICameraV2
    {
        ...
        public static string driverID = "ASCOM.cam8_v051.Camera";
        private static string driverDescription = "Cam8 v.0.51 ASCOM Driver";
...
#endif
        /// <summary>
        /// Initializes a new instance of the <see cref="cam81_v051"/> class.
        /// Must be public for COM registration.
        /// </summary>
        /// 

        //Imports cam8ll051.dll functions
        [DllImport("cam8ll051.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        public void StartExposure(double Duration, bool Light)
        {
            ...
            //Call function from cam8ll51.dll to start exposure
        ...
        public string DriverVersion
        {
            get
            {
                ...
                return String.Format(CultureInfo.InvariantCulture, "{0}.{51}", version.Major, version.Minor);
            }
        }
        ...
        public bool ImageReady
        {
            get
            {
                //get imare_ready flag from cam8ll051.dll
