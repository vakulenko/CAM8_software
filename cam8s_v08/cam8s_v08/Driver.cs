...
// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam8s v.0.8
// Edit Log:
...
{
    /// <summary>
    /// ASCOM Camera Driver for cam8s_v08.
    /// </summary>
    [Guid("749d1a33-2693-4e10-ae9f-33301c0b17ca")]
    ...
    public class TECControl
    {
        ...
        public TECControl(string comPort, bool traceEnabled)
        {
            ...
            tectl = new TraceLogger("", "tec_cam8s_v08");
    ...
    public class Camera : ICameraV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.cam8s_v08.Camera";

        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "Cam8s v.0.8 ASCOM Driver";
        ...
        //Imports cam8sll08.dll functions
        [DllImport("cam8sll08.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="cam8s_v08"/> class.
        ...
        public bool Connected
        {
            ...
            set
            {
                ...
                if (value)
                {
                    tl.LogMessage("Connected Set", "Connecting to camera, call cameraConnect from cam8sll08.dll");
                ...
                {
                    tl.LogMessage("Connected Set", "Disconnecting from camera, call cameraConnect from cam8sll08.dll");
        ...
        public string DriverInfo
        {
            get
            {
                ...
                string driverInfo = "Information about the driver itself. Version: " + String.Format(CultureInfo.InvariantCulture, "{0}.{8}", version.Major, version.Minor);
        ...
        public string DriverVersion
        {
            ...
            {
                Version version = System.Reflection.Assembly.GetExecutingAssembly().GetName().Version;
                string driverVersion = String.Format(CultureInfo.InvariantCulture, "{0}.{8}", version.Major, version.Minor);
        ...
        {
            tl.LogMessage("AbortExposure", "Aborting exposure, call cameraStopExposure from cam8sll08.dll");
        ...
        public CameraStates CameraState
        {
            get
            {
                tl.LogMessage("CameraState Get", "Call cameraGetError from cam8sll08.dll");
                ...
                tl.LogMessage("CameraState Get", "Call cameraGetCameraState from cam8sll08.dll");
        ...
        public object ImageArray
        {
            get
            {
                ...
                uint imagepoint;
                //Get image pointer
                tl.LogMessage("ImageArray Get", "Call cameraGetImage from cam8sll08.dll");
        ...
        public bool ImageReady
        {
            get
            {
                tl.LogMessage("ImageReady Get", "Call cameraGetImageReady from cam8sll08.dll");
        ...
        public void StartExposure(double Duration, bool Light)
        {
            ...
            tl.LogMessage("StartExposure", "Call cameraSetGain from cam8sll08.dll args: gain=" + settingsForm.gain.ToString());
            ...
            tl.LogMessage("StartExposure", "Call cameraSetOffset from cam8sll08.dll args: offset=" + settingsForm.offset.ToString());
            ...
            //start exposure
            tl.LogMessage("StartExposure", "Call cameraStartExposure from cam8sll08.dll, args: ");
        ...
        {
            tl.LogMessage("StopExposure", "Aborting exposure, call cameraStopExposure from cam8sll08.dll");
            if (cameraStopExposure() == false)
            {
        ...
        private bool IsConnected
        {
            get
            {
                tl.LogMessage("IsConnected Get", "Call cameraIsConnected from cam8sll08.dll");
