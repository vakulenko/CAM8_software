// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam85 v.0.2
// Edit Log:
...
namespace ASCOM.cam85_v02
{
    /// <summary>
    /// ASCOM Camera Driver for cam85_v02.
    /// </summary>
    [Guid("7cc8eeb2-36c7-45a3-bb7e-a018dc3d3eb2")]
    ...
    public class Camera : ICameraV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.cam85_v02.Camera";

        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "Cam85 v.0.2 ASCOM Driver";
        ...
        //Imports cam85ll02.dll functions
        ...
        public bool Connected
        {
            ...
            set
            {
                ...
                if (value)
                {
                    tl.LogMessage("Connected Set", "Connecting to camera, call cameraConnect from cam85ll02.dll");
                ...
                {
                    tl.LogMessage("Connected Set", "Disconnecting from camera, call cameraConnect from cam85ll02.dll");
        ...
        {
            tl.LogMessage("AbortExposure", "Aborting exposure, call cameraStopExposure from cam85ll02.dll");
        ...
        public CameraStates CameraState
        {
            get
            {
                tl.LogMessage("CameraState Get", "Call cameraGetError from cam85ll02.dll");
                ...
                tl.LogMessage("CameraState Get", "Call cameraGetCameraState from cam85ll02.dll");
        ...
        public object ImageArray
        {
            get
            {
                ...
                uint imagepoint;
                //Get image pointer
                tl.LogMessage("ImageArray Get", "Call cameraGetImage from cam85ll02.dll");
        ...
        public bool ImageReady
        {
            get
            {
                tl.LogMessage("ImageReady Get", "Call cameraGetImageReady from cam85ll02.dll");
        ...
        public void StartExposure(double Duration, bool Light)
        {
            ...
            tl.LogMessage("StartExposure", "Call cameraSetGain from cam85ll02.dll args: gain=" + settingsForm.gain.ToString());
            ...
            tl.LogMessage("StartExposure", "Call cameraSetOffset from cam85ll02.dll args: offset=" + settingsForm.offset.ToString());
        ...
        {
            tl.LogMessage("StopExposure", "Aborting exposure, call cameraStopExposure from cam85ll02.dll");
            if (cameraStopExposure() == false)
            {
        ...
        private bool IsConnected
        {
            get
            {
                tl.LogMessage("IsConnected Get", "Call cameraIsConnected from cam85ll02.dll");
