...
Function Set_USB_Parameters(var FT: DWord; InSize, OutSize:Dword) : FT_Result;
...
// IO Buffer Sizes
    FT_In_Buffer_Size = $2000000; //$8000000;  // 64k
    FT_In_Buffer_Index = FT_In_Buffer_Size - 1;
    FT_Out_Buffer_Size = $2000000; //$8000000; // 64k
...
Function Set_USB_Parameters(var FT:DWord; InSize,OutSize:Dword) : FT_Result ;
Begin
Result :=  FT_SetUSBParameters(FT,InSize,OutSize);
