// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam8 v.0.4
// Edit Log:
...
namespace ASCOM.cam8_v04
{
    ...
    public class Camera : ICameraV2
    {
        ...
        public static string driverID = "ASCOM.cam8_v04.Camera";
        private static string driverDescription = "Cam8 v.0.4 ASCOM Driver";
        ...
        //Imports cam8ll04.dll functions
        [DllImport("cam8ll04.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        public string DriverVersion
        {
            get
            {
                ...
                return String.Format(CultureInfo.InvariantCulture, "{0}.{4}", version.Major, version.Minor);
            }
        }
        ...
        public bool ImageReady
        {
            get
            {
                //get imare_ready flag from cam8ll04.dll
