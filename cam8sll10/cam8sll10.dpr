// --------------------------------------------------------------------------------
// ASCOM Camera driver low-level interaction library for cam8s_v0.8
// Edit Log:
...
// 17-aug-2015 VSS 0.8 Improved CCD reading algorithm by grim (increased black level duration in pixel reading procedure)
// 05-nov-2015 VSS 0.9 Only version changes
// 29-apr-2015 VSS 1.0 Added baudrate adjustment
// --------------------------------------------------------------------------------
...
begin
  ...
  begin
    FT_Out_Buffer[adress+0]:=dout[0]+$40;
    FT_Out_Buffer[adress+1]:=dout[0];
    FT_Out_Buffer[adress+2]:=dout[3]-$40;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        FT_Out_Buffer[adress+3]:=dout[3]-$40;
