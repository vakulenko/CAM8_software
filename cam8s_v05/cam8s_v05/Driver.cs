// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam8s v.0.5
// Edit Log:
// Date			Who	Vers	Description
// -----------	---	-----	-------------------------------------------------------
// 24-sep-2014  VSS 0.5     Initial release (based on cam8 v.0.4)
// --------------------------------------------------------------------------------
#define Camera
...
{
    [Guid("754b3250-1380-4940-afaf-3fd57a14ea7e")]
    ...
    public class Camera : ICameraV2
    {
        ...
        public static string driverID = "ASCOM.cam8s_v05.Camera";
        private static string driverDescription = "Cam8s v.0.5 ASCOM Driver";
...
#endif
        /// <summary>
        /// Initializes a new instance of the <see cref="cam81_v02"/> class.
        /// Must be public for COM registration.
        /// </summary>
        /// 

        //Imports cam8sll05.dll functions
        [DllImport("cam8sll05.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        public void StartExposure(double Duration, bool Light)
        {
            ...
            using (Stream writer = new FileStream("cam8s_v05.xml", FileMode.Create))
            {
                XmlSerializer serializer = new XmlSerializer(typeof(iniSettings));
                serializer.Serialize(writer, iniSet);
            }
            //Call function from cam8sll5.dll to start exposure
        ...
        public string DriverVersion
        {
            get
            {
                ...
                return String.Format(CultureInfo.InvariantCulture, "{0}.{5}", version.Major, version.Minor);
            }
        }
        ...
        public bool ImageReady
        {
            get
            {
                //get imare_ready flag from cam8sll05.dll
                ...
                if (m_ImageReady)
                {
                    ...
                    unsafe
                    {
                        ...
                        for (j = m_StartY; j < (m_StartY + m_NumY); j++)
                            ...
                            {
                                pixelpoint = (ushort*)(zeropixelpoint + (i * CameraYSizeConst + j));
