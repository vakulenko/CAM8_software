// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam85m v.0.1
// Edit Log:
// Date			Who	Vers	Description
// -----------	---	-----	-------------------------------------------------------
// 29-apr-2016  VSS 0.1     Initial
// --------------------------------------------------------------------------------
...
namespace ASCOM.cam85m_v01
{
    ...
    public class TECControl
    {
        ...
        public TECControl(string comPort, bool traceEnabled)
        {
            ...
            tectl = new TraceLogger("", "tec_cam85m_v01");
    ...
    public class Camera : ICameraV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.cam85m_v01.Camera";

        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "Cam85m v.0.1 ASCOM Driver";
        ...
        private const string LowLevelDLL = "cam85mll01.dll";

        //Imports cam85ll03.dll functions
        [DllImport("cam85mll01.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="cam85m_v01"/> class.
