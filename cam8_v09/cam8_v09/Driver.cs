// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam8 v.0.9
// Edit Log:
...
// 10-apr-2016  VSS 0.9     Added slow cooling, added baudrate adjustment
// --------------------------------------------------------------------------------
...
namespace ASCOM.cam8_v09
{
    /// <summary>
    /// ASCOM Camera Driver for cam8_v09.
    /// </summary>
    [Guid("d4602e37-eba4-432c-9930-a8132bafd925")]
    ...
    public class TECControl
    {
        ...
        public TECControl(string comPort, bool traceEnabled)
        {
            ...
            tectl = new TraceLogger("", "tec_cam8_v09");
    ...
    public class Camera : ICameraV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.cam8_v09.Camera";

        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "Cam8 v.0.9 ASCOM Driver";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="cam8_v09"/> class.
