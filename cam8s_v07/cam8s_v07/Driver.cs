...
// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam8s v.0.7
// Edit Log:
...
{
    /// <summary>
    /// ASCOM Camera Driver for cam8s_v07.
    /// </summary>
    [Guid("de033091-c2d3-4d77-a148-acb8008ee0d2")]
    ...
    public class Camera : ICameraV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.cam8s_v07.Camera";

        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "Cam8s v.0.7 ASCOM Driver";
        ...
        //Imports cam8sll07.dll functions
        ...
        public bool Connected
        {
            ...
            set
            {
                ...
                if (value)
                {
                    tl.LogMessage("Connected Set", "Connecting to camera, call cameraConnect from cam8sll07.dll");
                ...
                {
                    tl.LogMessage("Connected Set", "Disconnecting from camera, call cameraConnect from cam8sll07.dll");
        ...
        public string DriverInfo
        {
            get
            {
                ...
                string driverInfo = "Information about the driver itself. Version: " + String.Format(CultureInfo.InvariantCulture, "{0}.{7}", version.Major, version.Minor);
        ...
        public string DriverVersion
        {
            ...
            {
                Version version = System.Reflection.Assembly.GetExecutingAssembly().GetName().Version;
                string driverVersion = String.Format(CultureInfo.InvariantCulture, "{0}.{7}", version.Major, version.Minor);
        ...
        {
            tl.LogMessage("AbortExposure", "Aborting exposure, call cameraStopExposure from cam8sll07.dll");
        ...
        public object ImageArray
        {
            get
            {
                ...
                uint imagepoint;
                //Get image pointer
                tl.LogMessage("ImageArray Get", "Call cameraGetImage from cam8sll07.dll");
        ...
        public bool ImageReady
        {
            get
            {
                tl.LogMessage("ImageReady Get", "Call cameraGetImageReady from cam8sll07.dll");
        ...
        public void StartExposure(double Duration, bool Light)
        {
            ...
            tl.LogMessage("StartExposure", "Call cameraSetGain from cam8sll07.dll args: gain=" + settingsForm.gain.ToString());
            ...
            tl.LogMessage("StartExposure", "Call cameraSetOffset from cam8sll07.dll args: offset=" + settingsForm.offset.ToString());
            ...
            //start exposure
            tl.LogMessage("StartExposure", "Call cameraStartExposure from cam8sll07.dll, args: ");
        ...
        {
            tl.LogMessage("StopExposure", "Aborting exposure, call cameraStopExposure from cam8sll07.dll");
            if (cameraStopExposure() == false)
            {
        ...
        private bool IsConnected
        {
            get
            {
                tl.LogMessage("IsConnected Get", "Call cameraIsConnected from cam8sll07.dll");
