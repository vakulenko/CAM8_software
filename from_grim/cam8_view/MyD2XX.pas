...
Function Write_USB_Device_Buffer(var FT:DWord;Write_Count:Integer) : Integer;
...
// IO Buffer Sizes
    FT_In_Buffer_Size = $2000000;  // 2097152*2 // 64k
    FT_In_Buffer_Index = FT_In_Buffer_Size - 1;
    FT_Out_Buffer_Size = $4000000;//$10000;    // 64k
...
// Declare Input and Output Buffers
   FT_In_Buffer : Array[0..FT_In_Buffer_Index] of Byte;//word;
...
Begin
FT_IO_Status := FT_Write(FT,@FT_Out_Buffer,Write_Count,@Write_Result);
